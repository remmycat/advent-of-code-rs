...
pub fn y2015(c: &mut Criterion) {
	...
	// let input_01 = fs::read_to_string("assets/2015/input_01.txt").unwrap();
	// group.bench_with_input("Day 01: Sonar Sweep", &input_01, |b, i| {
	// 	b.iter(|| d01::solve(i))
	// });

	// let input_02 = fs::read_to_string("assets/2015/input_02.txt").unwrap();
	// group.bench_with_input("Day 02: Dive!", &input_02, |b, i| b.iter(|| d02::solve(i)));

	// let input_03 = fs::read_to_string("assets/2015/input_03.txt").unwrap();
	// group.bench_with_input("Day 03: Binary Diagnostic", &input_03, |b, i| {
	// 	b.iter(|| d03::solve::<12>(i))
	// });

	// let input_04 = fs::read_to_string("assets/2015/input_04.txt").unwrap();
	// group.bench_with_input("Day 04: Giant Squid", &input_04, |b, i| {
	// 	b.iter(|| d04::solve(i))
	// });

	// let input_05 = fs::read_to_string("assets/2015/input_05.txt").unwrap();
	// group.bench_with_input("Day 05: Hydrothermal Venture", &input_05, |b, i| {
	// 	b.iter(|| d05::solve(i))
	// });

	let input_06 = fs::read_to_string("assets/2015/input_06.txt").unwrap();
	group.bench_with_input("Day 06: Probably a Fire Hazard", &input_06, |b, i| {
		b.iter(|| d06::solve(i))
	});

	// let input_07 = fs::read_to_string("assets/2015/input_07.txt").unwrap();
	// group.bench_with_input("Day 07: The Treachery of Whales", &input_07, |b, i| {
	// 	b.iter(|| d07::solve(i))
	// });

	// let input_08 = fs::read_to_string("assets/2015/input_08.txt").unwrap();
	// group.bench_with_input("Day 08: Seven Segment Search", &input_08, |b, i| {
	// 	b.iter(|| d08::solve(i))
	// });

	// let input_09 = fs::read_to_string("assets/2015/input_09.txt").unwrap();
